...
export default function Home() {
  return (
    <div className="w-full lg:flex items-center justify-center min-h-screen">
      <div className="max-w-screen-lg p-8">
        ...
        <div className="gap:5 lg:gap-56 items-center flex flex-col lg:flex-row" >
          ...
          <div className=" lg:w-1/2  rounded-2xl p-4 mt-5 lg:ml-5 order-2" >
        ...
        <div className="gap:5 lg:gap-56 items-center flex flex-col lg:flex-row ">
          {/* Terminal section */}
          <div className="flex items-center justify-center w-full lg:w-1/2  rounded-2xl p-4 mt-5 md:ml-5 lg:order-2" >
            <Terminal />
          </div>
          {/* Image section */}
